...
b:Box("Pular","number",function(val)
J = val
end)
b:Box("Altura do quadril","number",function(val)
H = val
end)
b:Box("Gravidade","number",function(val)
G = val
end)
 
b:Toggle("Velocidade",function(bool)
getgenv().Speed = bool
Speed(S)
end)
b:Toggle("Pular",function(bool)
getgenv().Jump = bool
Jump(J)
end)
b:Toggle("Altura do quadril",function(bool)
getgenv().Hip = bool
Hip(H)
end)
b:Toggle("Gravidade",function(bool)
getgenv().Grav = bool
Grav(G)
end)
...
local b = w:CreateFolder("Coisas")
 
b:Box("Chat","Mensagem",function(val)
    C = val
end)
 
b:Box("Delay","Velocidade",function(val)
    CF = val
end)
 
b:Toggle("Spammar",function(bool)
    getgenv().Chat = bool
    Chat(C, CF)
end)
 
b:Button("Reentrar",function()
...
b:Button("Gigante",function()
	--Script fudido feito por neeky
...
b:Button("Resetar",function()
    game.Players.LocalPlayer.Character.Humanoid.Health = 0
end)
 
b:Button("RTX Verão",function()
    getgenv().mode = "Summer" -- Escolha entre Verão e o outro la
...
local b = w:CreateFolder("Creditos")
 
b:Label("Feito por 'neeky_' nome do discord!",{TextSize = 21; TextColor = Color3.fromRGB(255,255,255); BgColor = Color3.fromRGB(38, 38, 38);})
 
b:Button("Copiar convite do discord",function()
    setclipboard("https://discord.gg/wseV6fauqR")
end)
